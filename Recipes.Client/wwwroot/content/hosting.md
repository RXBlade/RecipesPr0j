...
##  [/Recipes.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Recipes.Client)
...
## [/Recipes](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Recipes)

The .NET 6 `/Recipes` backend server is required for this App's dynamic functions including the Hello API on the home page
